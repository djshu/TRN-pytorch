...
# parser.add_argument('dataset', type=str,default="something-something-v1", choices=['something-something-v1','jester','moments', 'somethingv2','charades'])
parser.add_argument('--dataset', type=str,default="something-something-v1", choices=['something-something-v1','jester','moments', 'somethingv2','charades'])
...
# parser.add_argument('--consensus_type', type=str, default='MultiScaleLSTM')
# parser.add_argument('--consensus_type', type=str, default='RelationModuleMultiScaleWithClassifier_h_after_sum')
# parser.add_argument('--consensus_type', type=str, default='TRNmultiscale')

parser.add_argument('--consensus_type', type=str, default='RelationModuleMultiScaleLSTM_RelationModuleMultiScale_num_layer1')
# parser.add_argument('--consensus_type', type=str, default='RelationModuleMultiScaleLSTM_RelationModuleMultiScale_num_layer2')
...
parser.add_argument('--root_p_d_path',type=str, default='')
