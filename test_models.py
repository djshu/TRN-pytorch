...
# parser.add_argument('dataset', type=str, choices=['something','jester','moments','charades','something-something-v1'])
parser.add_argument('--dataset', type=str,default='something-something-v1', choices=['something','jester','moments','charades','something-something-v1'])
...
parser.add_argument('--crop_fusion_type', type=str, default='RelationModuleMultiScaleLSTM_RelationModuleMultiScale_num_layer1',
                    choices=['avg', 'TRN','TRNmultiscale','RelationModuleMultiScaleWithClassifier',
                             'RelationModuleMultiScaleWithClassifier_h_after_sum',
                             'MultiScaleLSTM','RelationModuleMultiScaleLSTM_RelationModuleMultiScale_num_layer2',
                             'RelationModuleMultiScaleLSTM_RelationModuleMultiScale_num_layer1'])
...
net = TSN(num_class, args.test_segments if args.crop_fusion_type in ['TRN','TRNmultiscale',
                                                                     'RelationModuleMultiScaleWithClassifier',
                                                                      'RelationModuleMultiScaleWithClassifier_h_after_sum',
                                                                      'MultiScaleLSTM',
                                                                     'RelationModuleMultiScaleLSTM_RelationModuleMultiScale_num_layer2',
                                                                     'RelationModuleMultiScaleLSTM_RelationModuleMultiScale_num_layer1'  ] else 1, args.modality,
          base_model=args.arch,
          consensus_type=args.crop_fusion_type,
          img_feature_dim=args.img_feature_dim,
          )
...
def eval_video(video_data):
    ...
    if args.crop_fusion_type in ['TRN','TRNmultiscale','RelationModuleMultiScaleWithClassifier',
                             'RelationModuleMultiScaleWithClassifier_h_after_sum',
                             'MultiScaleLSTM','RelationModuleMultiScaleLSTM_RelationModuleMultiScale_num_layer2',
                                 'RelationModuleMultiScaleLSTM_RelationModuleMultiScale_num_layer1'
                                ]:
