...
def main():
    ...
    args.root_p_d_path = "/data/sjd/d/p_d/TRN-pytorch"


    args.root_model = os.path.join(args.root_p_d_path, args.dataset,"model")
    args.root_log = os.path.join(args.root_p_d_path, args.dataset,"log")
    args.root_output = os.path.join(args.root_p_d_path, args.dataset,"output")
    ...
    # ## TODO FOR DEBUG
    print("for debug eval begin")
    prec1 = validate(val_loader, model, criterion, (1 + 1) * len(train_loader), log_training)
    print("for debug eval ok")
...
def train(train_loader, model, criterion, optimizer, epoch, log):
    ...
    # print("in train, before enumerate ")
