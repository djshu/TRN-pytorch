...
class TSN(nn.Module):
    ...
    TSN Configurations:
        ...
        if consensus_type in ['TRN', 'TRNmultiscale','RelationModuleMultiScaleWithClassifier',
    ...
    def _prepare_tsn(self, num_class):
        ...
        if self.dropout == 0:
            ...
            if self.consensus_type in ['TRN','TRNmultiscale','RelationModuleMultiScaleWithClassifier',
                                        'RelationModuleMultiScaleWithClassifier_h_after_sum',
                                       'MultiScaleLSTM','RelationModuleMultiScaleLSTM_RelationModuleMultiScale_num_layer2',
                                       'RelationModuleMultiScaleLSTM_RelationModuleMultiScale_num_layer1' ]:
    ...
    def get_optim_policies(self):
        ...
        return [
            ...
            {'params': bn, 'lr_mult': 1, 'decay_mult': 0,
             'name': "BN scale/shift"},
            {'params':lstm_w,'lr_mult':1,'decay_mult':0,
             'name':"LSTM_weight"}
        ]
